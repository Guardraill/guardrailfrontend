...
export default function Navbar() {
  ...
  onMount(() => {
    ...
    window.addEventListener("guardrail:open-auth-modal", handleOpenAuthModal);

    onCleanup(() => {
      isDisposed = true;
      window.removeEventListener("guardrail:open-auth-modal", handleOpenAuthModal);
    });
        ...
        >
          ...
          <div class="pm-navbar__top-row">
            <div class="pm-navbar__brand-wrap">
              <a class="pm-brand" aria-label="GuardRail Logo" href="/">
                <span class="pm-brand__badge">
                  <img src="/c7xdtwf0cz6mneysxo8.svg" alt="" aria-hidden="true" />
                </span>
                <span class="pm-brand__name">GuardRail</span>
              </a>
            </div>
